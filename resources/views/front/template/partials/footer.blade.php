...
<div class="row final-footer hidden-sm">
...
<div class="container-fluid final-footer hidden-lg hidden-md text-center">
    <div class="row">
        <div class="col-sm-2"></div>
        <div class="col-sm-8 footer-mobile-div logo-footer text-center"><span class="footer-mobile-title">Carolina Silva</span></div>
        <div class="col-sm-2"></div>
    </div>
    <div class="row subitems-mobile">
        <div class="col-sm-4 text-right listado"><a href="{{route('front.search.category', 'TRAVELS')}}">TRAVELS</a></div>
        <div class="col-sm-4 text-center listado"><a href="{{route('front.search.category', 'INSPIRATION')}}">INSPIRATION</a></div>
        <div class="col-sm-4 text-left listado"><a href="{{route('front.search.category', 'LIFESTYLE')}}">LIFESTYLE</a></div>
    </div>
    <div class="row subitems-mobile">
        <div class="col-sm-4 text-right listado"><a href="{{route('front.search.category', 'FASHION')}}">FASHION</a></div>
        <div class="col-sm-4 text-center listado"><a href="{{ route('front.about') }}">ABOUT</a></div>
        <div class="col-sm-4 text-left listado"><a href="{{ route('front.contact') }}">CONTACT</a></div>
    </div>
